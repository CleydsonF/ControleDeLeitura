...
namespace TestePV.Controllers
{
    public class LeitoresController : Controller
    {
        ...
        public LeitoresController(TestePVContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LeitorId,LeitorNome,CPF,DataNascimento,Email,Telefone,Rua,Numero,Bairro,Cidade,UF")] Leitor leitor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("LeitorId,LeitorNome,CPF,DataNascimento,Email,Telefone,Rua,Numero,Bairro,Cidade,UF")] Leitor leitor)
        {
